...
def validate(val_loader, model, classifier, criterion, args, best_acc, best_model=None):
    ...
    plot_and_save_roc_curve(all_labels, all_preds, os.path.join('./roc_curve', f'roc_jmir_dat_fold_{args.fold_number}.png'))
     # Save labels and predictions for average ROC calculation
    np.save(os.path.join('./roc_curve', f'jmir_dat_fold_{args.fold_number}_labels.npy'), all_labels)
    np.save(os.path.join('./roc_curve', f'jmir_dat_fold_{args.fold_number}_preds.npy'), all_preds)
...
def main():
    ...
    if not args.eval:
        ...
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_train_before_class.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_train_before_domain.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_train_before_patient.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_train_after_pdc_class.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_train_after_pdc_domain.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_train_after_pdc_patient.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_val_after_pdc_class.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_val_after_pdc_domain.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
        ...
        # plt.ylabel('t-SNE feature 2')
        # plt.legend()
        # plt.savefig('./visualization/total/icbhi_val_after_pdc_patient.png', format='png', dpi=300, bbox_inches='tight')
        # plt.show()
